...
#define TITLE_COLOR [UIColor colorWithHexString:@"#43464c"]
...
-(void)show
{
    ...
    self.frame = [self getViewFrame];
    UIView *viewBlack = [[UIView alloc]initWithFrame:CGRectMake(0, self.frame.size.height, self.frame.size.width, 600)];
    viewBlack.backgroundColor = [UIColor blackColor];
    viewBlack.alpha = 0.25;
